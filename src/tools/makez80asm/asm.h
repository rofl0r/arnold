...
static void DAA(void)
{
        __asm 
        {
                mov ah,byte ptr [R.AF.B.l]                                      /* get flags */
                test ah, Z80_SUBTRACT_FLAG                                      /* subtract flag set ? */
                jne sdaa
                and ah, Z80_HALFCARRY_FLAG | Z80_CARRY_FLAG     /* get half carry and carry */
                sahf                                                                                    /* store ah to flags */
                mov al, byte ptr [R.AF.B.h]
                daa                                                                                     /* decimal adjust for addition */
                jmp     E_DAA
        sdaa:   
                and ah, Z80_HALFCARRY_FLAG | Z80_CARRY_FLAG
                sahf
                mov al, byte ptr [R.AF.B.h]
                das                                                                                     /* decimal adjust for subtraction */
        E_DAA:  
                lahf                                                            /* get new flags */
                mov byte ptr [R.AF.B.h], al                                     /* store result */
                and     ah, X86_AUXILIARY_FLAG | X86_CARRY_FLAG /* get half carry and carry */
                mov byte ptr [R.AF.B.l],ah                                      /* store these */
                or al,al
                lahf
                and ah, X86_SIGN_FLAG | X86_ZERO_FLAG | X86_PARITY_FLAG
                or byte ptr [R.AF.B.l],ah
        }
